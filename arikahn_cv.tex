...
Richard F. Betzel, John D. Medaglia, \textbf{Ari E. Kahn}, Jonathan Soffer, Daniel R. Schonhaut, and Danielle S. Bassett.
Inter-regional ECoG correlations predicted by communication dynamics, geometry, and correlated gene expression.
\textit{Nature Biomedical Engineering}.
In Press. (2019).

Elisabeth A. Karuza, \textbf{Ari E. Kahn}, and Danielle S. Bassett.
Human Sensitivity to Community Structure Is Robust to Topological Variation.
\textit{Complexity}
vol. 2019, Article ID 8379321 (2019).

%2018

\textbf{Ari E. Kahn}, Elisabeth A. Karuza, Jean M. Vettel, and Danielle S. Bassett.
Network constraints on learnability of probabilistic motor sequences.
\textit{Nature Human Behavior}
2, pp. 936-947 (2018).

Chris W. Lynn, \textbf{Ari E. Kahn}, and Danielle S. Bassett.
Structure from noise: Mental errors yield abstract representations of events.
arXiv (2018).

%2017

Graham L. Baum, Rastko Ciric, David R. Roalf, Richard F. Betzel, Tyler M. Moore, Russell T. Shinohara, \textbf{Ari E. Kahn}, Simon N. Vandekar, Petra E. Rupert, Megan Quarmley, Philip A. Cook, Mark A. Elliott, Kosha Ruparel, Raquel E. Gur, Ruben C. Gur, Danielle S. Bassett, and Theodore D. Satterthwaite.
...
\textbf{Ari E. Kahn}, Marcelo G. Mattar, Jean M. Vettel, Nicholas F. Wymbs, Scott T. Grafton, and Danielle S. Bassett.
Structural Pathways Supporting Swift Acquisition of New Visuomotor Skills.
\textit{Cerebral Cortex}
27.1, pp. 173–184 (2017).

Elisabeth A. Karuza, \textbf{Ari E. Kahn}, Sharon L. Thompson-Schill, and Danielle S. Bassett.
Process reveals structure: How a network is traversed mediates expectations about its architecture.
\textit{Scientific Reports}
7.1, p. 12733 (2017).

Jason Z. Kim, Jonathan M. Soffer, \textbf{Ari E. Kahn}, Jean M. Vettel, Fabio Pasqualetti, and Danielle S. Bassett.
Role of graph architecture in controlling dynamical networks with applications to neural systems.
\textit{Nature Physics}
(2017).

Ann E. Sizemore, Chad Giusti, \textbf{Ari Kahn}, Jean M. Vettel, Richard F. Betzel, and Danielle S. Bassett.
Cliques and cavities in the human connectome.
\textit{Journal of Computational Neuroscience}
pp. 1–31 (2017).

Steven H. Tompson, \textbf{Ari E. Kahn}, Emily B. Falk, Jean M. Vettel, and Danielle S. Bassett.
...
Evelyn Tang, Chad Giusti, Graham L. Baum, Shi Gu, Eli Pollock, \textbf{Ari E. Kahn}, David R. Roalf, Tyler M. Moore, Kosha Ruparel, Ruben C. Gur, Raquel E. Gur, Theodore D. Satterthwaite, and Danielle S. Bassett.
...
Shi Gu, Fabio Pasqualetti, Matthew Cieslak, Qawi K. Telesford, Alfred B. Yu, \textbf{Ari E. Kahn}, John D. Medaglia, Jean M. Vettel, Michael B. Miller, Scott T. Grafton, and Danielle S. Bassett.
